...
if (Meteor.isServer) {
  describe('UserInteractionCollection', function testSuite() {
    ...
    it('Cannot define duplicates', function test2() {
      ...
      const docID2 = UserInteractions.define({
        username,
        type,
        typeData,
      ...
      fc.assert(
        fc.property(
          ...
          (name, type, typeData, timestamp) => {
            ...
            expect(dumpObject2.typeData.length).to.equal(
              dumpObject.typeData.length,
            );
